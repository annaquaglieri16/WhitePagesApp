...
## Entried with timestamp NA are removed
...
for(i in 1:nrow(filesToExport)){
  ...
  dir.create(file.path(dirAppBackupImages,name_surname),showWarnings = FALSE,recursive = TRUE)
  ...
  rmarkdown::render(input=file.path(dirApp,"people_page_generator.Rmd"),
          output_file  = file.path(dirAppBackupImages,name_surname,"student_profile"),
          params = list(name = gsub("_"," ",name_surname)))
}
```
...
#                           "Lab skills","Equipment experience","Software experience","Hobbies/Interests","wehi_white_pages_complete","photo_upload","wehi_white_pages_complete","PhotoName")
